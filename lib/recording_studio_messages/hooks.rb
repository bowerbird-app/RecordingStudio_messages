...
module RecordingStudioMessages
  ...
  #   RecordingStudioMessages.configuration.hooks.after_initialize do
  ...
  class Hooks
    ...
    def log_hook_error(error, event_name, _hook)
      ...
      Rails.logger.error "[RecordingStudioMessages::Hooks] Error in #{event_name} hook: #{error.message}"
    ...
    class << self
      ...
      # @return [Array] Results from all hooks
      def run(event_name, *)
        RecordingStudioMessages.configuration.hooks.run(event_name, *)
      end
      ...
      def run_around(event_name, context, &)
        RecordingStudioMessages.configuration.hooks.run_around(event_name, context, &)
      end
