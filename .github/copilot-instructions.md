...
- Preserve engine namespace isolation under `RecordingStudioMessages` unless the task is explicitly about renaming the gem.
- Treat `docs/recording_studio_messages/` as architectural reference material. For current addon workflow, prefer the top-level README and the dummy app.
