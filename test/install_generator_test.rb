...
class InstallGeneratorTest < Minitest::Test
  ...
  def build_generator(destination_root, options = {})
    RecordingStudioMessages::Generators::InstallGenerator.new(
      [],
      options,
  ...
  def test_mount_engine_uses_configured_mount_path
    ...
    assert_equal ["mount RecordingStudioMessages::Engine, at: \"/addons/recording\""], routes
  end
  ...
  def test_install_guide_includes_migration_and_host_setup_steps
    ...
    assert_includes install_guide, "bin/rails generate recording_studio_messages:migrations"
